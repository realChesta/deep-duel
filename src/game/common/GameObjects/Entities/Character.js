...
class Character extends Creature {
  ...
  // TODO Modularize collision detection; create an ArcCollider or something alike
  ...
  attack(gameEngine) {
    ...
    if (this.state.setMainActionType(Character.ActionTypes.Attack)) {
